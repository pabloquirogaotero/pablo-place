function App() {
  return (
    <main className="flex flex-col max-w-3xl mx-auto px-8 text-ink">
      ...
      <section id="about" className="pt-16">
        ...
        <blockquote className="mt-16 border-l-4 border-accent pl-4 text-4xl italic">
      ...
      <section id="projects" className="pt-16">
        ...
        <h2 className="text-4xl pt-8">What I'm building now.</h2>
        <a href="https://github.com/pabloquirogaotero/beans" target="_blank" className="group block w-full mt-4 p-8 bg-cream-dark hover:bg-[#E0D9CE] cursor-pointer">
          ...
          <div className="flex justify-between pt-4">
            ...
            <p className="text-2xl font-bold text-accent pr-2 transition-all duration-300 group-hover:pr-0">&rarr;</p>
          </div>
        </a>
      </section>
      <section id="trajectory" className="pt-16">
        <div className="flex items-center gap-2">
          <p className="text-ink-light">Trajectory</p>
          <span className="flex-1 h-px bg-cream-dark"></span>
        </div>
        <h2 className="text-4xl pt-8">The journey.</h2>
        <div className="flex py-8 border-b border-cream-dark gap-16">
      ...
      <section id="contact" className="pt-16">
        ...
        <h2 className="text-4xl pt-8">Let's talk.</h2>
        <div className="flex justify-between items-baseline pt-8">
          ...
          <div className="w-1/2 grid grid-cols-[auto_auto] gap-x-8 gap-y-2 justify-end">
      ...
      <footer className="flex justify-between items-baseline pt-16 pb-8">
        <p>Pablo</p>
